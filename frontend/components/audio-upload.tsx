...
export function AudioUpload({ onFileChange }: AudioUploadProps) {
          ...
          <div className="flex flex-col items-center justify-center gap-2">
            {fileName ? (
              ...
              <>
                ...
                <h3 className="text-lg font-semibold">Solte seu áudio aqui</h3>
                <p className="text-sm text-gray-500 mb-4">ou clique para navegar</p>
                <Button onClick={handleButtonClick}>Selecionar Áudio</Button>
              </>
            )}
          </div>
        </div>
